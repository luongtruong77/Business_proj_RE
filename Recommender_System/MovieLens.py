...
class MovieLens:
    movieID_to_name = {}
    name_to_movieID = {}
    ratingsPath = 'C:/Metis_Bootcamp/Business_project/data/ml-latest-small/ratings.csv'
    moviesPath = 'C:/Metis_Bootcamp/Business_project/data/ml-latest-small/movies.csv'
